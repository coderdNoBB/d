...
public class TokenProvider {
    ...
    public void init() {
        byte[] keyBytes;
        String secret = jwtProperties.getKey();
        ...
        this.key = new SecretKeySpec(keyBytes, JWT_ALG.getJcaName());
...
//        User principal = new User(claims.getSubject(), "", authorities);
        return new XxAuthenticationToken(claims.getSubject() , token , authorities);
    }
